...
export default class Modal extends Global {
  ...
  #modalHTML() {
    return `
      <section class="modal" data-modal='${this.id}' data-type-modal='modal'>
      <div class="modal-header" data-type-modal='modalHeader'></div>
      <div id="content" data-type-modal='modalBody'></div>
      <div class="modal-footer" data-type-modal='modalFooter'>
        ${
          this.#useDoneButton
