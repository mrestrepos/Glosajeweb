...
try {
    ...
    $mail->Username   = 'glosajew@gmail.com';                     //SMTP username
    $mail->Password   = 'ekfwewtmerubyauo';                           //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                   //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('glosajew@gmail.com', 'glosajeWeb');
    ...
    $cuerpo .= '<p>Puedes cambiarla<a href=' . "http://localhost:8000/vistas/newPassword.php?email=" . $email . "&token=" . $token . "> aqui</a></p>";
