     ...
     <div class="contenedor__todo">
         ...
         <div class="contenedor__login-register">
             ...
             <form action="../controladores/LO_registroUsuario.php" method="POST" class="formulario__register" data-register="true">
                 ...
                 <input data-valid="false" data-field-name="id"" type=" number" placeholder="Nro Identificación" name="idUser" required="required">
                 ...
                 <input data-valid="false" data-field-name="email" type="email" placeholder="Correo Electronico" name="Correo" required="required">
                 <input data-valid="false" autocomplete="off" data-field-name="password" type="password" placeholder="Contraseña" name="Contrasena" required="required">
                 <input data-valid="false" autocomplete="off" data-field-name="password" type="password" name="confirmarContrasena" placeholder="Confirmar Contraseña" required="required">
                 ...
                 <button type="submit" disabled>Regístrarse</button>
             </form>
         </div>
     </div>
