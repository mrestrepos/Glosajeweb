...
if ($tipo_usuario == 2) {
    $sql = "SELECT codProducto,nombre_producto, descripcion,precio_producto,descuento, c.nombre_categoria AS categoria,p.activo FROM productos p INNER JOIN categorias c ON p.categoriaId = c.cod_categoria;";
...
<head>
    ...
    <link href="../assets/css/public/utils/fallbackMessages.css" rel="stylesheet" />
...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <i class="fas fa-boxes"></i><a href="../reportes/reExcel.php">Reporte EXCEL</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php while ($row = $resultado->fetch_assoc()) { ?>
                                        <tr>
                                            ...
                                            <td data-id=<?php echo $row['codProducto']; ?>>
                                                <a href="./editProduc.php?id=<?php echo $row['codProducto']; ?>" class="btn btn-primary">
                                                    <i class="fas fa-marker"></i>
                                                </a>
                                                <button class="btn btn-danger" data-global-type='deleteProduct'>
                                                    FF
                            ...
                            <div class="card card-body">
                                <form action="../controladores/createProd.php" method="post">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="form-select" name="idCategoria" aria-label="Default select example" id="categoryContainer">
    ...
    <script>
        ...
        fetch("./../controladores/getCategories.php").then(data => data.json())
            .then(setCategories)
    </script>
    ...
    <!-- <script src="../assets/js/public/products.js" type="module"></script> -->
    <script src="./../assets/js/public/global/index.js" type="module"></script>
</body>
