...
<body class="sb-nav-fixed" id="mainContainer">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-columns"></i>Lista de Categorias
                        </div>
                        <div class="card-body">
                            <?php
                            if ($tipo_usuario == 2) {
                            ?>
                                <table>
                                    ...
                                    <tbody data-global-render="setCategories"></tbody>
                                </table>
                ...
                <div class="container px-4 mx-auto">
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <div class="card-header">
                                <i class="fas fa-columns"></i>Agregar Categorias
                            </div>
                            <div class="card card-body">
                                <form method="post">
                                    <div class="form-group mb-4">
                                        <input type="text" name="categoryName" class="form-control" placeholder="Nombre" required="" autofocus>
                                    </div>
                                    <input type="submit" class="btn btn-primary" value="Agregar categoria" data-global-type='addCategory'>
                                </form>
                            </div>
                        </div>
                    </div>
...
ALTER TABLE productos ADD CONSTRAINT FOREIGN KEY(cod_categoria) REFERENCES categorias(cod_categoria) ON DELETE CASCADE;