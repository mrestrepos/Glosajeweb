                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <div class="card-header">
                                <i class="fas fa-boxes"></i> Editar Categorias
                            </div>
                            <div class="card card-body">
                                <form action="editCat.php?id=<?php echo  $idCategoria; ?>" method="post" data-global-id='<?php echo $categoryId; ?>'>
                                    <div class="form-group mb-4">
                                        <input type="text" data-global-render='setCategory' name="categoryName" disabled>
                                    </div>

                                    <input type="submit" class="btn btn-primary" value="Editar Categoria" name="update" data-global-type='updateCategory'>
                                    <a href="./categorias.php" class="btn btn-secondary">Regresar al menu</a>
                                </form>
                            </div>
